...
Revision ID: 5bdc20eb97da
Revises: 
Create Date: 2021-03-24 10:46:30.142552
...
def upgrade():
    ...
    sa.Column('lastlogin', sa.String(length=50), nullable=False),
    sa.Column('is_staff', sa.Boolean(), nullable=False),
    sa.Column('is_admin', sa.Boolean(), nullable=False),
    sa.Column('createddate', sa.String(length=50), nullable=False),
    ...
    sa.Column('dateupdate', sa.String(length=50), nullable=False),
    sa.Column('createddate', sa.String(length=50), nullable=False),
    sa.Column('orgid', sa.Integer(), nullable=True),
